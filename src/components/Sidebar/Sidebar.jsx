        ...
        <div className={style.sidebar}>
            <ul className={style.sidebarList}>
                <li className={style.sidebarItem}>
                    <a className={style.sidebarLink} href="https://github.com/VKryanin" target="_blank">
                ...
                <li className={style.sidebarItem}>
                    <a className={style.sidebarLink} href="https://t.me/RJKvCyMbXo" target="_blank">
                ...
                <li className={style.sidebarItem}>
                    <a className={style.sidebarLink} href="https://instagram.com/sooooooooooooooqa" target="_blank">
